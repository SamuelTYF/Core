			...
			while (true)
			{
				...
				switch (State)
				{
					case 0:
						...
						else if (symbol is '%' or >= '(' and <= '*' or ',' or '/' or >= ':' and <= ';' or '[' or >= ']' and <= '^' or '{' or '}') { Push(symbol); State = 3; Index++; }
						...
						else if (symbol is '.' or '?') { Push(symbol); State = 7; Index++; }
						else if (symbol is '0') { Push(symbol); State = 8; Index++; }
						else if (symbol is >= '1' and <= '9') { Push(symbol); State = 9; Index++; }
						else if (symbol is '=') { Push(symbol); State = 10; Index++; }
						else if (symbol is '@') { Push(symbol); State = 11; Index++; }
						else if (symbol is >= 'A' and <= 'Z' or >= 'a' and <= 'z') { Push(symbol); State = 12; Index++; }
					...
					case 1:
						...
						break;
					case 2:
						if (symbol is '=') { Push(symbol); State = 3; Index++; }
					...
					case 3:
						...
						break;
					case 4:
						if (symbol is >= ' ' and <= '&' or >= '(' and <= '[' or >= ']' and <= '\uffff') { Push(symbol); State = 14; Index++; }
					...
					case 6:
						if (symbol is '-') { Push(symbol); State = 3; Index++; }
						else if (symbol is >= '0' and <= '9') { Push(symbol); State = 9; Index++; }
						else { token = new(Value.ToString()); return ReturnToken(token); }
						break;
					case 7:
						if (symbol is '?') { Push(symbol); State = 3; Index++; }
						...
						break;
					case 8:
						if (symbol is >= '0' and <= '9') { Push(symbol); State = 9; Index++; }
						else if (symbol is '.') { Push(symbol); State = 16; Index++; }
						else if (symbol is 'b') { Push(symbol); State = 17; Index++; }
						else if (symbol is 'x') { Push(symbol); State = 18; Index++; }
					...
					case 9:
						...
						break;
					case 10:
						if (symbol is >= '=' and <= '>') { Push(symbol); State = 3; Index++; }
						else { token = new(Value.ToString()); return ReturnToken(token); }
						break;
					case 11:
						if (symbol is '@') { Push(symbol); State = 3; Index++; }
						else if (symbol is '"') { Push(symbol); State = 19; Index++; }
						else if (symbol is >= '0' and <= '9' or >= 'A' and <= 'Z' or >= 'a' and <= 'z') { Push(symbol); State = 20; Index++; }
						else { token = new(Value.ToString()); return ReturnToken(token); }
						break;
					case 12:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'Z' or '_' or >= 'a' and <= 'z') { Push(symbol); State = 12; Index++; }
					...
					case 14:
						...
						break;
					case 15:
						if (symbol is '\'') { Push(symbol); State = 22; Index++; }
						else if (symbol is '0') { Push(symbol); State = 23; Index++; }
						else if (symbol is '\\') { Push(symbol); State = 24; Index++; }
						else if (symbol is 'a') { Push(symbol); State = 25; Index++; }
						else if (symbol is 'b') { Push(symbol); State = 26; Index++; }
						else if (symbol is 'f') { Push(symbol); State = 27; Index++; }
						else if (symbol is 'n') { Push(symbol); State = 28; Index++; }
						else if (symbol is 'r') { Push(symbol); State = 29; Index++; }
						else if (symbol is 't') { Push(symbol); State = 30; Index++; }
						else if (symbol is 'u') { Push(symbol); State = 31; Index++; }
						else if (symbol is 'v') { Push(symbol); State = 32; Index++; }
						else return Error(symbol);
						break;
					case 16:
						if (symbol is >= '0' and <= '9') { Push(symbol); State = 33; Index++; }
						else return Error(symbol);
						break;
					case 17:
						if (symbol is >= '0' and <= '1') { Push(symbol); State = 34; Index++; }
						else return Error(symbol);
						break;
					case 18:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'F' or >= 'a' and <= 'f') { Push(symbol); State = 35; Index++; }
						else return Error(symbol);
						break;
					case 19:
						if (symbol is >= '\u0001' and <= '!' or >= '#' and <= '\uffff') { Push(symbol); State = 19; Index++; }
						else if (symbol is '"') { Push(symbol); State = 36; Index++; }
						else return Error(symbol);
						break;
					case 20:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'Z' or >= 'a' and <= 'z') { Push(symbol); State = 20; Index++; }
					...
					case 21:
						...
						break;
					case 22:
						if (symbol is '\'') { Push(symbol); State = 37; Index++; }
						else return Error(symbol);
						break;
					case 23:
						if (symbol is '\'') { Push(symbol); State = 38; Index++; }
						else return Error(symbol);
						break;
					case 24:
					...
					case 30:
						...
						break;
					case 31:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'F' or >= 'a' and <= 'f') { Push(symbol); State = 46; Index++; }
						else return Error(symbol);
						break;
					case 32:
					...
					case 33:
						if (symbol is >= '0' and <= '9') { Push(symbol); State = 33; Index++; }
						else if (symbol is 'e') { Push(symbol); State = 48; Index++; }
					...
					case 45:
						...
						break;
					case 46:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'F' or >= 'a' and <= 'f') { Push(symbol); State = 49; Index++; }
						else return Error(symbol);
						break;
					case 47:
						...
						break;
					case 48:
						if (symbol is '-') { Push(symbol); State = 50; Index++; }
						else if (symbol is >= '0' and <= '9') { Push(symbol); State = 51; Index++; }
						else return Error(symbol);
						break;
					case 49:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'F' or >= 'a' and <= 'f') { Push(symbol); State = 52; Index++; }
						else return Error(symbol);
						break;
					case 50:
						if (symbol is >= '0' and <= '9') { Push(symbol); State = 51; Index++; }
						else return Error(symbol);
						break;
					case 51:
						if (symbol is >= '0' and <= '9') { Push(symbol); State = 51; Index++; }
						...
						break;
					case 52:
						if (symbol is >= '0' and <= '9' or >= 'A' and <= 'F' or >= 'a' and <= 'f') { Push(symbol); State = 53; Index++; }
						else return Error(symbol);
						break;
					case 53:
						if (symbol is '\'') { Push(symbol); State = 54; Index++; }
						else return Error(symbol);
						break;
					case 54:
