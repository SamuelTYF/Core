		...
		public int[] Dimensions
		{
			get
			{
				...
				else
				{
					...
					case 200:
					case 201:
						array = new int[1] { ((Array)val).GetLength(0) };
						break;
					case 202:
					case 203:
						array = new int[2]
					...
					case 100:
					{
						...
						int num2 = checkHeads(Head.ToString(), 0, num);
						array = new int[num2];
		...
		public override int GetHashCode()
		{
			...
			if (val != null)
			{
				...
				else if (type == 202)
				{
					...
					for (int l = array3.GetLowerBound(0); l <= upperBound; l++)
					{
						for (int m = array3.GetLowerBound(1); m <= upperBound2; m++)
						{
							num += array3[l, m];
						}
					}
				...
				else if (type == 203)
				{
					...
					for (int n = array4.GetLowerBound(0); n <= upperBound3; n++)
					{
						for (int num2 = array4.GetLowerBound(1); num2 <= upperBound4; num2++)
						{
							num += (int)array4[n, num2];
						}
					}
				}
			}
