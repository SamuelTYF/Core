	...
	internal class COMTypeLibraryLoader
	{
		...
		internal class ImporterNotiferSink : ITypeLibImporterNotifySink
		{
			...
			public Assembly ResolveRef(object typeLib)
				=>generateAssemblyFromTypeLib((ITypeLib)typeLib, safeArrayAsArray, asmDir, out _);
		}
		...
		internal static Assembly generateAssemblyFromTypeLib(ITypeLib typeLib, bool safeArrayAsArray, string asmFilePath, out bool foundPIAInstead)
		{
			...
			bool primaryInteropAssembly = typeLibConverter.GetPrimaryInteropAssembly(tYPELIBATTR.guid, tYPELIBATTR.wMajorVerNum, tYPELIBATTR.wMinorVerNum, tYPELIBATTR.lcid, out string asmName, out _);
